        ...
        <header className="bg-white shadow-sm sticky top-0 z-50">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-4">
                    ...
                    <Link to="/cart" className="text-gray-600 hover:text-orange-500 relative">
                ...
                <div className="md:hidden flex items-center space-x-3">
                    <Link to="/cart" className="text-gray-600 hover:text-orange-500"><FiShoppingCart size={24} /></Link>
                    ...
                    <nav className="flex flex-col p-4 space-y-2">
                        ...
                        {navLinks.map((link) => (
                            <NavLink
                                ...
                                className={({ isActive }) => `
                                    p-2 rounded
                                    ${isActive ? 'bg-orange-100 text-orange-500' : 'text-gray-700'}
                                    ${link.special ? 'text-red-500 font-semibold' : ''}
                                `}
