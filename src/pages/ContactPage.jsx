...
import { FiPhone, FiMail, FiMapPin, FiClock, FiFacebook, FiInstagram, FiYoutube, FiSend } from 'react-icons/fi';
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitStatus({ type: 'success', message: 'Cảm ơn bạn đã liên hệ! Chúng tôi sẽ phản hồi sớm.' });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl opacity-90">Chúng tôi rất vui khi nhận tin từ bạn</p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <div className="flex gap-4">
                  <a href={shopInfo?.facebookUrl} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-orange-500 text-2xl transition-colors">
                    <FiFacebook />
                  </a>
                  <a href={shopInfo?.instagramUrl} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-orange-500 text-2xl transition-colors">
                    <FiInstagram />
                  </a>
                  <a href={shopInfo?.youtubeUrl} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-orange-500 text-2xl transition-colors">
                    <FiYoutube />
                  </a>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="font-bold text-gray-800 mb-2">Giờ mở cửa là mấy giờ?</h3>
              <p className="text-gray-600">Chúng tôi mở cửa từ thứ 2 đến thứ 7, từ 8:00 sáng đến 20:00 tối. Chủ nhật từ 9:00 sáng đến 19:00 tối.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="font-bold text-gray-800 mb-2">Bạn có cung cấp dịch vụ giao hàng không?</h3>
              <p className="text-gray-600">Có, chúng tôi cung cấp dịch vụ giao hàng tại TP HCM và các tỉnh lân cận với giá cạnh tranh.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="font-bold text-gray-800 mb-2">Chính sách đổi trả như thế nào?</h3>
              <p className="text-gray-600">Bạn có thể đổi hoặc trả lại sản phẩm trong vòng 7 ngày nếu sản phẩm bị lỗi hoặc không vừa vặn.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="font-bold text-gray-800 mb-2">Bạn chấp nhận những phương thức thanh toán nào?</h3>
              <p className="text-gray-600">Chúng tôi chấp nhận thanh toán tiền mặt, chuyển khoản ngân hàng, và các ứng dụng thanh toán di động.</p>
            </div>
          </div>
        </div>
      </section>
